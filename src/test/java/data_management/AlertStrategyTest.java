...
public class AlertStrategyTest {
    ...
    private BPAlertFactory bloodPressureAlertFactory;
    private ECGAlertFactory heartRateAlertFactory;
    private BOAlertFactory oxygenSaturationAlertFactory;
    ...
    public void setUp() {
        ...
        bloodPressureAlertFactory = new BPAlertFactory();
        heartRateAlertFactory = new ECGAlertFactory();
        oxygenSaturationAlertFactory = new BOAlertFactory();
    }

    @Test
    public void testBloodPressureStrategy() {
        AlertStrategy strategy = new BPStrategy(bloodPressureAlertFactory);
