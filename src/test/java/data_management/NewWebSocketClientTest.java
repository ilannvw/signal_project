...
import com.data_management.NewWebSocketClient;
...
class NewWebSocketClientTest {
    private DataStorage mockDataStorage;
    private NewWebSocketClient client;

    @BeforeEach
    void setUp() throws URISyntaxException {
        mockDataStorage = mock(DataStorage.class);
        client = new NewWebSocketClient("ws://localhost:8080", mockDataStorage);
    }
